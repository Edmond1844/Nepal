    ...
    <>
      ...
      <div className={styles.hero}>
        <picture className={styles.hero__picture}>
          <source media="(min-width: 1024px)" srcSet={heroBackgroundDesktop} />
          <source media="(min-width: 360px)" srcSet={heroBackgroundMobile} />
          <img
        ...
        <div className={styles.hero__content}>
          <h1 className={styles.hero__title}>{language[lang].title}</h1>
